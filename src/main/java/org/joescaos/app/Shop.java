...
public class Shop {
  ...
  public static void main(String[] args) {
    ...
    productManagerSP.reviewProduct(42, Rating.TWO_STAR, "muy caro");
    productManagerSP.printProductReport(42);
    productManager.printProducts(p -> p.getPrice().floatValue() < 10,(p1, p2) -> p2.getRating().ordinal() - p1.getRating().ordinal());
    productManagerSP.printProducts(p -> p.getPrice().floatValue() < 10, (p1, p2) -> p2.getPrice().compareTo(p1.getPrice()));
    productManager.printProducts(p -> p.getPrice().floatValue() < 10, (p1, p2) -> p2.getBestBefore().compareTo(p1.getBestBefore()));
